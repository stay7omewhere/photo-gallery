...
var Preview = function({photos, viewPhotoHandler, showShare, closePopup, showPopup, saved, saveListing}) {
    ...
    <div>
      <PreviewDiv>
        <ListingActions>
          ...
          <SaveListing onClick={saveListing}>
            <Heart saved={saved} viewBox="0 0 24 24">
